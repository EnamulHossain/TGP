...
@section('content')
    <section class="lg:mt-20 lg:mx-36 pt-10">
        ...
        <div class="basis-1/2 "><br>
            ...
            <form action="{{ route('change.password.post') }}" method="POST" class="mt-10">
                @csrf
                ...
                <div class="form-control w-full max-w-md">
                    ...
                    <div class="col-md-6">
                        <div class="relative">
                            <input type="password" id="old_password" class="input input-bordered w-full max-w-md mt-4" name="old_password" autofocus>
                            <span class="eye-icon" onclick="togglePasswordVisibility('old_password')"><i class="fas fa-eye-slash"></i></span>
                        </div>
                ...
                <div class="col-md-6 offset-md-4">
                    <button type="submit" class="rounded w-full max-w-md px-3 py-2 mt-5 bg-[#2d4352] text-[#fff] border-[#2d4352] border-2 hover:bg-white hover:text-[#2d4352]">Change Password</button>
                </div>
            </form>
