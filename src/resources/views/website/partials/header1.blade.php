...
<header class="relative">
    <nav class="navbar z-50 fixed top-0 pt-5 pb-2 px-10 md:px-32 bg-white">
        ...
        <div class="navbar-end">
            <div class="dropdown dropdown-end">
                ...
                <label tabindex="0" class="btn btn-ghost header1 focus:bg-white lg:hidden">
                    menu
                ...
                <ul tabindex="0"
                class="menu mainmenu dropdown-content mt-3 p-1 text-sm font-normal shadow bg-slate-100 rounded-box w-80 border-[1px] border-solid border-[#2D4352]">
                <li>
                    ...
                    {{-- <li><a href="{{route('website.add.grant')}}">Add Grants</a></li> --}}
        ...
        <div class="navbarclass">
            <ul style="font-weight: 300; gap: 1rem; line-height: 2rem; font-size: 1.8rem" class="menu menu-horizontal px-2 text-3xl">
                ...
                <li tabindex="0">
                    ...
                    <ul style="gap:1.5rem;" class="menu py-6 px-3 border-[1px] border-solid border-[#2D4352] bg-white">
                ...
                @auth()
                <a style="font-weight: 400;" class="hover:underline hover:underline-offset-8 hover:bg-white mt-5 mx-4" href="{{ route('auth.logout') }}">Log Out</a>
                <a style="border-width: 3px; width: 110px; background-color: #e0ae67; border-color: #e0ae67; color: black; text-transform:capitalize; font-weight: 100; height: 50px; font-size: 16px; border-radius: 1rem;" class="btn btn-outline mx-1 text-base" onmouseover="this.style.backgroundColor='white'; this.style.color='black';" onmouseout="this.style.backgroundColor='#e0ae67'; this.style.color='black';" href="{{ route('my-profile') }}">Profile</a>
                @endauth
                @guest
                <a style="font-weight: 400;" class="hover:underline hover:underline-offset-8 hover:bg-white mt-5 mx-4 text-center" href="{{ route('website.login') }}">Log In</a>
                <a style="border-width: 3px; width: 110px; background-color: #e0ae67; border-color: #e0ae67; color: black; text-transform:capitalize; font-weight: 100; height: 50px; font-size: 16px; border-radius: 1rem; text-decoration-line: none" class="btn btn-outline mx-1 text-base" onmouseover="this.style.backgroundColor='white'; this.style.color='black';" onmouseout="this.style.backgroundColor='#e0ae67'; this.style.color='black';" href="{{ route('website.signup') }}">Sign Up</a>
                @endguest
            </ul>
        </div>
    </nav>
