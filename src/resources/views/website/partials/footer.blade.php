<footer class="footer felx flex-row justify-between text-primary py-10 px-10 md:px-20 border-t-[3px] border-solid border-[#2D4352]">  
    <div>
        <img src=" {{asset('images/TGP-favicon.png')}}" alt="The Grant Portal Logo" width="100" height="71">
        <p>1100 Park Central Blvd S<br/> Promero Beach, FL 33064 <br> 
        <i class="fa fa-phone-square" aria-hidden="true"></i>
        (954)-935-8800</p>
    </div> 

    <div class="mt-0 md:mt-20">
        <div class="grid grid-flow-col gap-4 text-base underline underline-offset-1">
    ...
    <div class="text-base mt-0 md:mt-20">
        &copy;2023 Promero, Inc.  All Rights Reserved
    </div> 

    <div class="mt-0 md:mt-12">
        <button>
            <a style="border-width: 1px; width: 130px; background-color: #000000; border-color: #000000; color: white; text-transform:capitalize"
            class="btn btn-outline mx-1 text-base capitalize"
